...
def apply_uniaxial_pml(
    ...
    permittivity = _crop_and_edge_pad_pml_region(permittivity, widths=(width_u, width_v))

    du, dv = _normalized_distance_into_pml(permittivity.shape, widths=(width_u, width_v))
    ...
    return (permittivity_xx, permittivity_xy, permittivity_yx, permittivity_yy, permittivity_zz)
...
def _crop_and_edge_pad_pml_region(
    ...
    arr_cropped = arr[..., i_width:arr.shape[-2] - i_width, j_width:arr.shape[-1] - j_width]
